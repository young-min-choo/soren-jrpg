...
export const JOBS = {
  ...
  Mage: {
    ...
    abilities: [
      ...
      { name: 'Ice', mpCost: 4, jpCost: 30, level: 1, type: 'magic', power: 1.4, element: 'ice', description: 'Ice damage to one enemy.' },
      { name: 'Thunder', mpCost: 6, jpCost: 60, level: 5, type: 'magic', power: 1.8, element: 'thunder', description: 'Thunder damage to one enemy.' },
    ],
  },
  Ranger: {
    name: 'Ranger',
